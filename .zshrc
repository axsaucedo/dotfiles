...
# # Build our prompt (CURRENTLY BUGGY)
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status virtualenv kube_ps1 background_jobs)
...
plugins=(
  ...
  kube-ps1
  kubectl # git clone https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/kubectl.git $ZSH_CUSTOM/plugins/kubectl
  gcloud # git clone https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/gcloud.git $ZSH_CUSTOM/plugins/gcloud
  docker
  golang
  helm
  fzf
...
alias gi='git init'
alias gitignore-init='cp ~/Programming/lib/global_gitignore .gitignore'
